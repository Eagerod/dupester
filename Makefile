...
PUBLISH := publish/linux-amd64 publish/darwin-amd64 publish/darwin-arm64
...
.PHONY: container
container: $(BIN_NAME)
	docker build . --build-arg VERSION="$$version" -t "registry.internal.aleemhaji.com/$(EXECUTABLE):latest"
